      ...
      <div className="card-shell">
        <div className="card" style={{ textAlign: 'center', padding: '60px 40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '300px', margin: '0 auto' }}>
            <a href="https://expo.dev/accounts/ronithganji/projects/merch/builds/25e9e191-f8e1-4b22-9cb7-c8377eeeccf1" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
